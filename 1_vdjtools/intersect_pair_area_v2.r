#args <- c("isotyper_Fully_reduced_LEA_S15.vdjtools.3_Nt-sequences", "isotyper_Fully_reduced_LEA_S7.vdjtools.3_Nt-sequences", "/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/2207.paired.aa.table.collapsed.txt", "/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/2207.paired.aa.table.collapsed.pdf")
#
