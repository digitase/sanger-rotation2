#args <- c("/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/pairwise.intersect.batch.aaVJ.txt", "1", "2", "17", "0", "0", "0", "1", "2", "NA", "F", "/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/pairwise.hc.aaVJ.F.pdf", "/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/pairwise.mds.aaVJ.F.pdf", "T", "/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/pairwise.hc.aaVJ.F.newick.txt", "/nfs/users/nfs_b/bb9/workspace/rotation2/1_vdjtools/.output/pairwise.mds.aaVJ.F.txt")
